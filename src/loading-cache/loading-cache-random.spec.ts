...
//
//   load$(key: string): Observable<ILoadResult<TestRecord>> {
...
//             key,
//             this._keyToLoadCountMap.get(key) + 1
//           );
//
//           return {
//             timestamp: Date.now(),
...
//   }
//
//   store$(key: string, value: TestRecord): Observable<ILoadResult<TestRecord>> {
//     const loadTime = getRandomIntFromInterval(0, maxLoadTime);
//     const shouldThrowError = Math.random() > 0.5;
//
//     return timer(loadTime).pipe(
...
//             key,
//             this._keyToStoreCountMap.get(key) + 1
//           );
//
//           return {
//             timestamp: Date.now(),
...
//   }
//
//   private _initKeyIfNotExists(key: string) {
