...
// const timeout = 200;
//
// function isCurrentTimestampApproximatelyEqualTo(timestamp: number): boolean {
//   const currentTimestamp = Date.now();
//   return (
//     timestamp - allowedApproximateTimeDifference <= currentTimestamp &&
...
//
//   load$(key: TestKey): Observable<ILoadResult<TestRecord>> {
...
//           );
//           this._keyToLastStoredValueMap.set(key.key, value);
//
//           return {
...
//           tap(record => {
//             expect(
//               isCurrentTimestampApproximatelyEqualTo(
//                 expectedLoadFinishTimestamp
//               )
//             ).toBeTruthy();
//
...
//         expect(
//           isCurrentTimestampApproximatelyEqualTo(expectedLoadFinishTimestamp)
//         ).toBeTruthy();
//
...
//         catchError(err => {
//           expect(
//             isCurrentTimestampApproximatelyEqualTo(expectedStoreFinishTimestamp)
//           ).toBeTruthy();
//           return of(err);
//         })
//       )
...
//       expect(
//         isCurrentTimestampApproximatelyEqualTo(
//           expectedLoadFinishTimestampList[0]
//         )
//       ).toBeTruthy();
//
//       expect(record.key).toBe(key.key);
...
//                   expect(
//                     isCurrentTimestampApproximatelyEqualTo(
//                       expectedLoadFinishTimestampList[1]
//                     )
//                   ).toBeTruthy();
//
//                   expect(recordLocal.key).toBe(key.key);
...
//       expect(record.storeCount).toBe(0);
//
//       timer(refreshTime + allowedApproximateTimeDifference)
//         .pipe(first())
//         .subscribe(() => {
//           expectedLoadFinishTimestampList.push(Date.now());
//           forkJoin(
...
//                       expect(
//                         isCurrentTimestampApproximatelyEqualTo(
//                           expectedLoadFinishTimestampList[2]
//                         )
//                       ).toBeTruthy();
//
//                       expect(recordLocal.key).toBe(key.key);
...
//             )
//             .subscribe(() => {
//               timer(loadTime + allowedApproximateTimeDifference)
//                 .pipe(first())
//                 .subscribe(() => {
//                   expectedLoadFinishTimestampList.push(Date.now());
//                   loadingCache
...
//                 expect(
//                   isCurrentTimestampApproximatelyEqualTo(
//                     expectedStoreFinishTimestampList[index]
//                   )
//                 ).toBeTruthy();
//
//                 expect(record.key).toBe(key.key);
